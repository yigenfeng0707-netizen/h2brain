...
const NAV_ITEMS = [
  ...
  { key: '/react', label: '智能决策面板（ReAct）', icon: '*' },
  { key: '/agents/hydrogen_opt', label: '氢耗优化智能体', icon: 'H2' },
  { key: '/agents/route_plan', label: '路径规划智能体', icon: 'R' },
  { key: '/agents/station_dispatch', label: '加氢站调度智能体', icon: 'S' },
  { key: '/agents/fleet_manage', label: '车队管理智能体', icon: 'F' },
  { key: '/agents/cost_analysis', label: '成本分析智能体', icon: 'Y' },
  { key: '/agents/fuelcell_health', label: '燃料电池健康智能体', icon: 'H' },
  { key: '/architecture', label: '五层技术架构', icon: '#' },
  { key: '/case', label: '案例数据看板', icon: '+' },
  { key: '/pricing', label: '服务定价方案', icon: '¥' },
  { key: '/trip-analysis', label: '行程分析看板', icon: '~' },
